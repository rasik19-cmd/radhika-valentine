...
function showMessage(response) {
  ...
  if (response === "No") {
    ...
    // Change the image source to "cry.gif"
...
audioElement.loop = true;
    ...
    yesMessage.textContent = "Every season with you will be my favorite ❤️";
    yesMessage.style.display = "block";
    yesMessage.style.fontStyle = "normal";
    document.getElementsByClassName("image")[0].src = "images/dance.gif";
document.getElementsByClassName("image")[0].style.maxHeight = "350px";
